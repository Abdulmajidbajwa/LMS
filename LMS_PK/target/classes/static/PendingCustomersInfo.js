...
function generateTable(table, data,columnIndexToSkip) {
    ...
    for (key in element) {
	    /*if(key!==columnIndexToSkip.toString() && (element[4]=="INITIATED" ||element[4]=="OTP_GENERATED_BEFORE_ACTIVATION" || element[4]=="OTP_VERIFIED_BEFORE_ACTIVATION")){
	        let cell = row.insertCell();
	        let text = document.createTextNode(element[key]);
	        cell.appendChild(text);
	    }*/
    	if((element[4]=="INITIATED" ||element[4]=="OTP_GENERATED_BEFORE_ACTIVATION" || element[4]=="OTP_VERIFIED_BEFORE_ACTIVATION")){
	        let cell = row.insertCell();
	        let text = document.createTextNode(element[key]);
	        cell.appendChild(text);
	    }
