//*********************************************************************GetKycQuestion Api
	...
	xhr.open("POST", "/LMSServer/getPaidOrUnpaidDisbursedLoans?isPaidRequired=true");
	...
	for(i=0;i<applicationInfoJsonData.data.length;i++){
		   ...
		   /* //Add Edit Button at the end of each line
		    let cell6 = row.insertCell();
		  	...
		  	button.setAttribute("id",loanId); //user id
		  	button.setAttribute("value",cellNo); // user Username
...
function applicationDetailPage(e){
	...
	writeCookie("selectedCustomerLoanRequest",e.value, "1");
